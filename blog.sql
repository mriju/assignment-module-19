...
-- Dumping structure for table laravel.blog_posts
...
-- Dumping data for table laravel.blog_posts: ~0 rows (approximately)
INSERT INTO `blog_posts` (`id`, `title`, `content`, `created_at`, `updated_at`) VALUES
	(1, 'Twitter rival Threads signs up 100 million users in 5 days', 'The Threads app launched by Instagram as a rival to Twitter has signed up more than 100 million users in less than five days, data tracking websites said on Monday, smashing the record of AI tool ChatGPT for fastest-growing consumer app.', '2023-07-11 04:48:39', '2023-07-11 04:48:39'),
	(2, 'Ukraine\'s future membership to be discussed by leaders in Vilnius', 'The 31 allies hope to show Russia they have the resolve to support Ukraine militarily for the long term.', '2023-07-11 06:23:57', '2023-07-11 06:23:57'),
	(3, 'The rush for nickel: \'They are destroying our future\'', 'They are from an indigenous community of Bajau people - renowned freedivers who find it better to hunt in the dark when fish, lobsters and sea cucumbers are less active.', '2023-07-11 06:24:33', '2023-07-11 06:24:33');
...
CREATE TABLE IF NOT EXISTS `comments` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `comments_blog_post_id_foreign` (`blog_post_id`),
...
-- Dumping data for table laravel.comments: ~0 rows (approximately)
INSERT INTO `comments` (`id`, `blog_post_id`, `content`, `created_at`, `updated_at`) VALUES
	(1, 1, 'Good', '2023-07-11 04:49:13', '2023-07-11 04:49:13');
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(5, '2023_07_11_043054_create_blog_posts_table', 1),
	(6, '2023_07_11_043146_create_comments_table', 1);
